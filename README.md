...
```
npm install @deviousm/react-split-pane
```
...
### Preventing remount of components

If your component is remounting because of dynamic count of Panes you can put a `name` prop on it.

```html
<SplitPane>
  {isDynamicallyShown && <Pane name="iWillBeShownLater"></Pane>}
  <Pane name="iWontNeedToRerenderWhenMyIndexChanges"></Pane>
</SplitPane>
```
